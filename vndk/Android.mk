...
include $(CLEAR_VARS)
LOCAL_MODULE := libstagefright_xmlparser-v28
LOCAL_MULTILIB := both
LOCAL_SRC_FILES_arm := v28/arm/arch-arm-armv7-a-neon/shared/vndk-core/libstagefright_xmlparser.so
LOCAL_SRC_FILES_arm64 := v28/arm64/arch-arm64-armv8-a/shared/vndk-core/libstagefright_xmlparser.so
LOCAL_MODULE_SUFFIX := .so
LOCAL_MODULE_CLASS := SHARED_LIBRARIES
LOCAL_MODULE_TARGET_ARCH := arm arm64
LOCAL_MODULE_TAGS := optional
